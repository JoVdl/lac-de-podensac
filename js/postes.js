...
const POSTES = [
  {
    ...
    icon: "🌿",
    images: ["images/poste 1.jpg", "images/illustration poste 1.jpg"],
  ...
  },
  {
    ...
    icon: "🦆",
    images: ["images/Poste 3.jpg", "images/poste 3 (2).jpg", "images/poste 3 (3).jpg", "images/poste 3 (4).jpg"],
  ...
  },
  {
    ...
    icon: "⚓",
    images: ["images/poste 4.jpg", "images/illustation poste 4.jpg", "images/illustation poste 4 (2).jpg"],
  ...
  },
  {
    ...
    description: "Grand poste de 1,82 ha. Zone prometteuse avec de belles perspectives de captures.",
    ...
    equipements: ["Banc de pêche", "Accès rive"],
  ...
  },
  {
    ...
    icon: "🌊",
    images: ["images/poste 6.jpg", "images/poste 6 (2).jpg", "images/poste 6 (3).jpg"],
  ...
  },
  {
    ...
    icon: "🪵",
    images: ["images/poste 7 ponton.jpg"],
  ...
  },
  {
    ...
    icon: "🏗️",
    images: ["images/poste de la cale.jpg", "images/poste de la cale (2).jpg", "images/poste de la cale (3).jpg", "images/illustration poste cale.jpg"],
  ...
  },
  {
    ...
    icon: "🌸",
    images: ["images/poste des iris.jpg"],
